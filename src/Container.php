...
use function com\bj58\pay\model\entity\getAccountType;
use fuwu\common\base\InvalidConfigException;
use fuwu\common\base\Object;
use ReflectionClass;
...
class Container extends Object
{
    ...
    public function get($class, $params = [], $config = [])
    {
        ...
        if (is_callable($definition, true)) {
            ...
            $config = $this->mergeParams($definition, $config);
    ...
    protected function build($class, $params, $config)
    {
        ...
        if (!empty($dependencies) && $reflection->implementsInterface('fuwu\common\base\Configurable')) {
